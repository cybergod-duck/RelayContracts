 ...
 * @notice This contract takes control of the old relay and redirects all fees to the correct treasury
 * It maintains the same interface as BaseRelayV3 but redirects fees to the correct wallet
 */
contract TreasuryController is Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Main swap function that redirects fees to correct treasury
     * This replaces the functionality of the old relay
     */
    function swap(
        address tokenIn,
        address tokenOut,
    ...
    /**
     * @notice Manually capture and redirect existing funds from old relay
     */
